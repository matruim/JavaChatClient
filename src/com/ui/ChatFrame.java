...
public class ChatFrame extends javax.swing.JFrame {
    ...
    // Creates instances of all needed variables and builds the layout of the main frame.
    private void initComponents() {

    	// Instantiate all objects
        instantiateAllObjects();
        
        //setup server host addressing
        connectToServer();
    ...
    /*
     * Connect to server. This button is only available if the auto login fails
     */
    ...
    /*
     * Login to server. This button is only available if the auto login fails
     */
    ...
    /*
     * Signup for a login. This button is only available if the auto login fails
     */
    @SuppressWarnings("deprecation")
    ...
    /*
     * Select a file to upload to a user
     */
    ...
    /*
     * Upload File to user if file is less than 125MB
     */
    ...
    /*
     * This button Controls the History Files loading
     */
	...
	private void instantiateAllObjects(){
        ...
        //key listener for sending messages
        ...
        jTextField1.setText("10.31.10.64");
        ...
        //setup history file
        jTextField6.setText("h:\\ChatHistory.xml");
        historyFile = jTextField6.getText();
        jTextField6.setEditable(false);
        jButton7.setEnabled(false);
