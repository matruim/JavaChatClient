            ...
            try {
                ...
                if(msg.type.equals("message")){
                    if(msg.recipient.equals(ui.username)){
                        ...
                        //play sound
                        AudioPlayer player = new AudioPlayer("C:\\WINDOWS\\Media\\tada.wav");
                        player.start();
                    }
                    else if(msg.recipient.equals("All")){
                    	if(msg.sender.equals("System")){
                    		//play sound
                            AudioPlayer player = new AudioPlayer("\\\\172.16.0.10\\apps\\IT.wav");
                            player.start();
                    	}
                    	else{
                    		//play sound
                            AudioPlayer player = new AudioPlayer("C:\\WINDOWS\\Media\\notify.wav");
                            player.start();
                    	}
                    ...
                    if(!msg.content.equals(".bye") && !msg.sender.startsWith(ui.username)){
